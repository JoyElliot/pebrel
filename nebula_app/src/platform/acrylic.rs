//! Optional Windows App SDK Acrylic, owned by the GPUI UI thread.
//! See architecture/notes/nebula_app/platform/2026-09-22-acrylic-controller.md.
...
use composition::{Backdrop, Context};
